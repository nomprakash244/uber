...
const ConfirmRide = (props) => {
  return (
    <div>
      ...
      <h5 onClick={() => props.setconfirmRidePanel(false)} className='p-1 text-center w-[90%] absolute top-0 '><i className=' text-3xl  text-gray-200  ri-arrow-down-wide-line'></i></h5>
